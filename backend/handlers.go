...
func Posthandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		for _, post := range posts {
			...
			newPost.Message = post.Message.String
			newPost.CreatedAt = post.CreatedAt.String()
			newPost.Image = post.Image.String

			curUser, err := query.GetUserById(context.Background(), post.ID)
			...
			newPost.Avatar = curUser.Image.String
			newPost.Fname = curUser.FirstName
			newPost.Lname = curUser.LastName
			newPost.Nname = curUser.NickName.String
