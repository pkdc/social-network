...
const ChatUserItem = (props) => {
    ...
    return (
        <div className={styles["item"]} onClick={openChatboxHandler}>
            ...
            {!props.avatar && <Avatar className={styles["chat-avatar"]} online={onlineStatus} src={require("../../../images/"+`${defaultImagePath}`)} alt="" height={"30px"} width={"30px"}/>}
            {props.avatar && <Avatar className={styles["chat-avatar"]} online={onlineStatus} src={props.avatar} alt="" height={"30px"} width={"30px"}/>}
